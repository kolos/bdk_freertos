...
//   <e> CFG_BLE_MESH_MSG_API
//      <i>  CFG_BLE_MESH_MSG_API
//   </e>
#if ( CFG_SUPPORT_BLE_MESH )
...
//   <e> CFG_SLEEP
//   <i> enable SYSTEM_SLEEP
//   </e>
#if ( 1 )
#define CFG_SLEEP 
#endif

//   <e> CFG_BLE_ADV_TEST_MODE
//      <i> CFG_BLE_ADV_TEST_MODE
//   </e>
#if ( CFG_SUPPORT_BLE_MESH )
...
{
#if DISPLAY_SUPPORT
    KERNEL_EVENT_DISPLAY    = 0,
#endif //DISPLAY_SUPPORT

#if RTC_SUPPORT
    KERNEL_EVENT_RTC_1S_TICK  = 1,
#endif //RTC_SUPPORT

#ifdef CFG_AUDIO_RSA
    KERNEL_EVENT_RSA_SIGN = 2,
#endif // CFG_AUDIO_RSA

#if SECURE_CONNECTIONS
    KERNEL_EVENT_ECC_MULTIPLICATION = 3,
#endif // SECURE_CONNECTIONS

#if BLE_EMB_PRESENT
    KERNEL_EVENT_BLE_CRYPT    = 4,
#endif //BLE_EMB_PRESENT

    KERNEL_EVENT_KERNEL_MESSAGE   = 5,

#if defined(CFG_BLE_MESH)
    KERNEL_EVENT_BLE_MESH_DJOB = 6,
#endif // defined(CFG_BLE_MESH)
    KERNEL_EVENT_KERNEL_TIMER    = 7,   ///0302
#if (AHI_TL_SUPPORT)
...
#if (BLE_HOST_PRESENT)
    TASK_BLE_L2CC = 6,    // L2CAP Controller Task
    TASK_BLE_GATTM = 7,   // Generic Attribute Profile Manager Task
    TASK_BLE_GATTC = 8,   // Generic Attribute Profile Controller Task
    TASK_BLE_GAPM = 9,    // Generic Access Profile Manager
    TASK_BLE_GAPC = 10,    // Generic Access Profile Controller

    // allocate a certain number of profiles task
    TASK_BLE_PRF_MAX = (TASK_BLE_GAPC + BLE_NB_PROFILES),//BLE_NB_PROFILES MAX ROM USE == 6

#ifdef BLE_AUDIO_AM0_TASK
    TASK_BLE_AM0 = TASK_BLE_PRF_MAX + 1,     // BLE Audio Mode 0 Task
...
enum
{
    ...
    // The BLE free Exchange memory
    KERNEL_MEM_BLE_EM_FREE,
...
#if (BLE_EMB_PRESENT || BLE_HOST_PRESENT)
#define RWIP_HEAP_NON_RET_SIZE   (( 512 * BLE_CONNECTION_MAX ) + 16384 + 4096)// (( 512 * BLE_CONNECTION_MAX ) + 16384)
#else
